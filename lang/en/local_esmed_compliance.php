...
// Privacy metadata.
$string['privacy:metadata:local_esmed_compliance_sessions'] = 'Certifiable session records used as attendance evidence under article D.6353-4 of the French Labour Code.';
$string['privacy:metadata:local_esmed_compliance_sessions:userid'] = 'The Moodle user whose session is recorded.';
$string['privacy:metadata:local_esmed_compliance_sessions:courseid'] = 'The course the session is attached to, if any.';
$string['privacy:metadata:local_esmed_compliance_sessions:session_start'] = 'The timestamp when the session was opened.';
$string['privacy:metadata:local_esmed_compliance_sessions:session_end'] = 'The timestamp when the session was closed.';
$string['privacy:metadata:local_esmed_compliance_sessions:ip_address'] = 'The IP address the session originated from.';
$string['privacy:metadata:local_esmed_compliance_sessions:user_agent'] = 'The browser user-agent string at session opening.';
$string['privacy:metadata:local_esmed_compliance_sessions:duration_seconds'] = 'Effective duration of the session, in seconds.';
$string['privacy:metadata:local_esmed_compliance_sessions:closure_type'] = 'How the session was closed (logout, timeout, beacon, crash, manual).';

$string['privacy:metadata:local_esmed_compliance_activity_log'] = 'Aggregated time spent and view counts per course module.';
$string['privacy:metadata:local_esmed_compliance_activity_log:userid'] = 'The Moodle user whose module activity is aggregated.';
$string['privacy:metadata:local_esmed_compliance_activity_log:courseid'] = 'The course the module belongs to.';
$string['privacy:metadata:local_esmed_compliance_activity_log:cmid'] = 'The course module identifier.';
$string['privacy:metadata:local_esmed_compliance_activity_log:time_spent_seconds'] = 'Total time the learner spent on this module, in seconds.';
$string['privacy:metadata:local_esmed_compliance_activity_log:views_count'] = 'Number of times the learner opened this module.';
$string['privacy:metadata:local_esmed_compliance_activity_log:completion_state'] = 'Completion state as seen by the plugin.';

$string['privacy:metadata:local_esmed_compliance_assessment_index'] = 'Categorised assessment attempts (pedagogical quizzes, mock exams, summative assessments).';
$string['privacy:metadata:local_esmed_compliance_assessment_index:userid'] = 'The Moodle user who made the attempt.';
$string['privacy:metadata:local_esmed_compliance_assessment_index:courseid'] = 'The course the assessment belongs to.';
$string['privacy:metadata:local_esmed_compliance_assessment_index:cmid'] = 'The course module identifier of the assessment.';
$string['privacy:metadata:local_esmed_compliance_assessment_index:assessment_type'] = 'Regulatory classification of the assessment.';
$string['privacy:metadata:local_esmed_compliance_assessment_index:score'] = 'Raw score obtained.';
$string['privacy:metadata:local_esmed_compliance_assessment_index:grade_percent'] = 'Score normalised to a 0-100 scale.';
$string['privacy:metadata:local_esmed_compliance_assessment_index:attempt_date'] = 'Date of the attempt.';

$string['privacy:metadata:local_esmed_compliance_archive_index'] = 'Index of sealed documents (certificates, funder statements) attached to a user.';
$string['privacy:metadata:local_esmed_compliance_archive_index:userid'] = 'The Moodle user the sealed document is about.';
$string['privacy:metadata:local_esmed_compliance_archive_index:courseid'] = 'The course the sealed document relates to.';
$string['privacy:metadata:local_esmed_compliance_archive_index:archive_type'] = 'Type of sealed document.';
$string['privacy:metadata:local_esmed_compliance_archive_index:file_path'] = 'Storage path of the sealed file.';
$string['privacy:metadata:local_esmed_compliance_archive_index:sha256_hash'] = 'SHA-256 fingerprint of the sealed file.';
$string['privacy:metadata:local_esmed_compliance_archive_index:verification_token'] = 'Public token used for third-party verification.';
$string['privacy:metadata:local_esmed_compliance_archive_index:timestamp_sealed'] = 'Timestamp at which the document was sealed.';
$string['privacy:metadata:local_esmed_compliance_archive_index:retention_until'] = 'Timestamp after which the document becomes eligible for purge.';

$string['privacy:metadata:local_esmed_compliance_alerts'] = 'History of learner dropout and inactivity alerts.';
$string['privacy:metadata:local_esmed_compliance_alerts:userid'] = 'The Moodle user the alert concerns.';
$string['privacy:metadata:local_esmed_compliance_alerts:courseid'] = 'The course the alert relates to, if any.';
$string['privacy:metadata:local_esmed_compliance_alerts:alert_type'] = 'Type of alert raised.';
$string['privacy:metadata:local_esmed_compliance_alerts:alert_data_json'] = 'Structured payload attached to the alert.';
$string['privacy:metadata:local_esmed_compliance_alerts:triggered_at'] = 'When the alert was generated.';
